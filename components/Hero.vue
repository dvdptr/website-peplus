  ...
  <div class="spacing border-b border-gray-400 flex pylg justify-around items-center">
    <div class="w-1/2 mx-4">
      <section>
        ...
        ><a href="mailto:someone@yoursite.com" target="_blank" rel="noopener noreferrer">Anfrage stellen</a></button>
        <button
          class="bg-white hover:bg-red-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow ml-3"
        ><nuxt-link  to="/videoberatung">Videoberatung</nuxt-link></button> -->
      </section>
    </div>
