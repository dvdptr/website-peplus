    ...
    >
      ...
      <div class="comp-width">
        <p>
          ...
          Geschäftsleitung der Peter Ebner Finanzberatung Plus. Eine Nutzung der
          Internetseiten der Peter Ebner Finanzberatung Plus ist grundsätzlich
        ...
        <br />
        <p class="text-xl font-bold">1. Begriffsbestimmungen</p>
        <br />
        <p>
          Die Datenschutzerklärung der Peter Ebner Finanzberatung Plus beruht
        ...
        <p>Peter Ebner Finanzberatung Plus</p>
        <p>Im Bungert 5</p>
        <p>54317 Herl</p>
        <p>Deutschland</p>
        <p>Tel.: 015112669832</p>
        <p>E-Mail: info@finanzberatung-ebner.de</p>
        <p>Website: www.finanzberatung-ebner.de</p>
        <br />
        ...
        <br />
        <p>
          Die Internetseite der Peter Ebner Finanzberatung Plus erfasst mit
        ...
        <br />
        <p>
          Die Internetseite der Peter Ebner Finanzberatung Plus enthält aufgrund
        ...
        <ul style="list-style: none;">
          ...
          <li>
            ...
            <p>
              ...
              bei der Peter Ebner Finanzberatung Plus gespeichert sind,
              ...
              Mitarbeiter der Peter Ebner Finanzberatung Plus wird veranlassen,
          ...
          <li>
            ...
            <p>
              ...
              Daten, die bei der Peter Ebner Finanzberatung Plus gespeichert
              sind, verlangen möchte, kann sie sich hierzu jederzeit an einen
              Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter der Peter Ebner Finanzberatung Plus wird die
          ...
          <li>
            ...
            <p>
              ...
              Person gegenüber der Peter Ebner Finanzberatung Plus der
        ...
        <p>
          ...
          Komponenten von Xing integriert. Xing ist ein Internetbasiertes
          soziales Netzwerk, das die Konnektierung der Nutzer mit bestehenden
          ...
          Profil von sich anlegen. Unternehmen können beispielsweise
        ...
        <p>
          ...
          veranlasst, eine Darstellung der entsprechenden Xing-Komponente von
          Xing herunterzuladen. Weitere Informationen zum den Xing-Plug-Ins
          können unter https://dev.xing.com/plugins abgerufen werden. Im Rahmen
          dieses technischen Verfahrens erhält Xing Kenntnis darüber, welche
        ...
        <p>
          ...
          integrierten Xing-Buttons, beispielsweise den „Share“-Button, ordnet
          Xing diese Information dem persönlichen Xing-Benutzerkonto der
        ...
        <p>
          ...
          <a
            ...
            rel="nofollow"
            >Externer Datenschutzbeauftragter Memmingen</a
          >
